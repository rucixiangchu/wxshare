...
public class Md5CryptTool {
	...
	public static String apr1Crypt(final byte[] keyBytes, String salt) {
		...
		return Md5CryptTool.md5Crypt(keyBytes, salt, APR1_PREFIX);
	}
	...
	public static String md5Crypt(final byte[] keyBytes, final String salt, final String prefix) {
		...
		final MessageDigest ctx = DigestUtilsTool.getMd5Digest();
		 ...
		 */
		MessageDigest ctx1 = DigestUtilsTool.getMd5Digest();
		...
		for (int i = 0; i < ROUNDS; i++) {
			ctx1 = DigestUtilsTool.getMd5Digest();
			if ((i & 1) != 0) {
				ctx1.update(keyBytes);
			} else {
